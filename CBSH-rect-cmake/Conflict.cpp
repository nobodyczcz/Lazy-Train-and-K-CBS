...
bool operator < (const Conflict& conflict1, const Conflict& conflict2) // return true if conflict2 has higher priority
{
	...
	else if (conflict1.p == conflict_priority::CARDINAL) // both are cardinal
	{
	    ...
	    else if (conflict1.type == conflict_type::RECTANGLE4 || conflict1.type == conflict_type::RECTANGLE){
	    ...
	    else if (conflict1.type == conflict_type::CORRIDOR2 && conflict2.type != conflict_type::CORRIDOR2)
		{
				return false;
		}
